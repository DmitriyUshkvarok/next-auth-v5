...
import { ResumeEducationProps } from './types/types';
interface ResumeEducationPropsData {
  educationData: ResumeEducationProps | null;
}
    ...
    <div className="flex flex-col sm:flex-row gap-4">
      <div className="w-full sm:w-1/3">
        ...
        <motion.p
          ...
          transition={{ duration: 0.7, delay: 0.7 }} // Задержка для описания
        >
          {educationData?.description[locale]}
        </motion.p>
      </div>
